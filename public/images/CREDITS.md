...
All images are stored locally under `/images/`. Sources and licenses:

| File | Used on | Source | License / notes |
|------|---------|--------|-----------------|
| `bill-huizenga.jpg` | Bill Huizenga profile, cards, OG | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Rep._Bill_Huizenga_-_118th_Congress_(portrait_crop).jpg) — U.S. House of Representatives | **Public domain** (U.S. Congress official portrait) |
| `holland-lighthouse.jpg` | Holland hub hero | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Holland_Harbor_Light_(Big_Red)_-_Holland,_Michigan.jpg) by Andrew Parodi | **CC BY-SA 3.0** — attribution: Andrew Parodi / Wikimedia Commons |
| `holland-home-hero.jpg` (+ `-640`, `-1024`, `-1600`) | Homepage featured hero | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Holland_MI_16M_(3858254690).jpg) by Peter C in Toronto Canada | **CC BY 2.0** — attribution on page |
| `home-hero.jpg` | — (alternate Holland imagery) | [Unsplash](https://unsplash.com/photos/1520763185295) (tulips) | Unsplash License (free use; credit appreciated) |
| `holland-tulips.jpg` | — (alternate Holland imagery) | [Unsplash](https://unsplash.com/photos/1490750967868) | Unsplash License |
| `lake-michigan-beach.jpg` | Site default OG image | [Unsplash](https://unsplash.com/photos/rbWnL675K-I) by Tyler Casey — Oval Beach, Saugatuck, MI | Unsplash License |
| `lake-michigan-dunes.jpg` | — (alternate regional) | [Unsplash](https://unsplash.com/photo-1506905925346) | Unsplash License |
| `great-lakes-shore.jpg` | — (alternate regional) | [Unsplash](https://unsplash.com/photos/d6e8U8myhWs) — Lake Michigan near Indiana Dunes | Unsplash License |
| `civic-placeholder.jpg` | State/local legislator profiles & cards | [Unsplash](https://unsplash.com/photos/1529107386315) | Unsplash License — generic civic imagery; not official portraits |
| `article-townhall.jpg` | Article: constituent access | [Pexels](https://www.pexels.com/photo/1550337/) | Pexels License (free use) |
...
| `gary-peters.jpg` | Gary Peters profile & cards | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Gary_Peters,_official_portrait,_114th_Congress_(cropped).jpg) — U.S. Senate Photographic Studio (2015) | **Public domain** (official U.S. Senate portrait) |
| `elissa-slotkin.jpg` | Elissa Slotkin profile & cards | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Elissa_Slotkin_2026_Official_Portrait_(cropped).jpg) — official Senate portrait, Jan 2026 | **Public domain** (official U.S. Senate portrait) |
| `roger-victory.jpg` | Roger Victory profile & cards | [Michigan Senate GOP caucus](https://www.senatorrogervictory.com/photos/) official headshot (2019) | Caucus photos page states photos "are intended for media and public use and may be freely reproduced." Credit: Michigan Senate Republican Caucus |
| `bradley-slagh.jpg` | Bradley Slagh profile & cards | [Michigan House Republicans](https://gophouse.org/member/repbradleyslagh/about) official portrait (2021) | Official caucus portrait; no explicit license. Editorial use; credit: Michigan House Republicans |
| `eric-deboer.jpg` | Eric DeBoer profile & cards | [Michigan Sheriffs' Association — Ottawa County](https://www.misheriff.org/sheriffs-offices/ottawa-county/) official sheriff portrait (2025) | © MSA / Ottawa County Sheriff's Office; no explicit license. Editorial use; credit: Michigan Sheriffs' Association |
| `sarah-matwiejczyk.jpg` | Sarah Matwiejczyk profile & cards | [Ottawa County — Prosecuting Attorney](https://miottawa.org/prosecutor/) official headshot | Same Ottawa County terms as the commissioner photos above |
| `justin-roebuck.jpg` | Justin Roebuck profile & cards | [Ottawa County — Clerk/Register of Deeds](https://miottawa.org/clerk/) official headshot | Same Ottawa County terms as above |
| `cheryl-clark.jpg` | Cheryl Clark profile & cards | [Ottawa County — Treasurer](https://miottawa.org/treasurer/) official headshot | Same Ottawa County terms as above |
| `jim-barry.jpg` | Jim Barry profile & cards | [Ottawa County Board — District 1](https://boards.miottawa.org/commissioner/district-1/) official 2025-term headshot | Same Ottawa County terms as above |
| `keith-van-beek.jpg` | Keith Van Beek profile & cards | [City of Holland — City Manager's Office](https://www.cityofholland.com/154/City-Managers-Office) official photo (Fall 2018) | © City of Holland; no explicit license. Editorial use; credit: City of Holland, Michigan. Only published at 200×280 — replace if the city posts a larger portrait |

Only the Whitmer, Peters, and Slotkin photos carry a true free license (public domain). The rest are official government headshots used for civic/editorial purposes with source credit — standard practice for official portraits, but if the site ever runs ads or otherwise becomes commercial, request written permission (Ottawa County explicitly requires it for commercial use) or replace those images. `civic-placeholder.jpg` is retained as a fallback for any future officials without a usable portrait.
